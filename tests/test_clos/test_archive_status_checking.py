...
def test_archive_already_archived_job():
    ...
    with requests_mock.Mocker() as m:
        ...
        m.get(
            "https://cloudos.lifebit.ai/api/v3/jobs?teamId=workspace_123&archived.status=true&page=1&limit=1&id=already_archived_job",
            status_code=200,
...
def test_unarchive_already_unarchived_job():
    ...
    with requests_mock.Mocker() as m:
        ...
        m.get(
            "https://cloudos.lifebit.ai/api/v3/jobs?teamId=workspace_123&archived.status=true&page=1&limit=1&id=not_archived_job",
            status_code=200,
        ...
        m.get(
            "https://cloudos.lifebit.ai/api/v3/jobs?teamId=workspace_123&archived.status=false&page=1&limit=1&id=not_archived_job",
            status_code=200,
...
def test_archive_mixed_status_jobs():
    ...
    with requests_mock.Mocker() as m:
        ...
        m.get(
            "https://cloudos.lifebit.ai/api/v3/jobs?teamId=workspace_123&archived.status=true&page=1&limit=1&id=already_archived",
            status_code=200,
            json={"jobs": [{"_id": "already_archived", "status": "completed"}], "pagination_metadata": {"Pagination-Count": 1}}
        )

        m.get(
            "https://cloudos.lifebit.ai/api/v3/jobs?teamId=workspace_123&archived.status=true&page=1&limit=1&id=not_archived",
            status_code=200,
            json={"jobs": [], "pagination_metadata": {"Pagination-Count": 0}}
        )
        m.get(
            "https://cloudos.lifebit.ai/api/v3/jobs?teamId=workspace_123&archived.status=false&page=1&limit=1&id=not_archived",
            status_code=200,
...
def test_unarchive_mixed_status_jobs():
    ...
    with requests_mock.Mocker() as m:
        # Mock job status - one archived, one not archived
        m.get(
            "https://cloudos.lifebit.ai/api/v3/jobs?teamId=workspace_123&archived.status=true&page=1&limit=1&id=archived_job",
            status_code=200,
