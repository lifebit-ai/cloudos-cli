...
def test_job_archive_successful_flow():
    ...
    with requests_mock.Mocker() as m:
        ...
        m.get(
            "https://cloudos.lifebit.ai/api/v2/jobsNew?teamId=workspace_123&archived.status=true&page=1&limit=1&id=valid_job_123",
            status_code=200,
        ...
        m.get(
            "https://cloudos.lifebit.ai/api/v2/jobsNew?teamId=workspace_123&archived.status=false&page=1&limit=1&id=valid_job_123",
            status_code=200,
...
def test_job_archive_multiple_jobs_successful_flow():
    ...
    with requests_mock.Mocker() as m:
        ...
        for job_id in ['job1', 'job2', 'job3']:
            ...
            m.get(
                f"https://cloudos.lifebit.ai/api/v2/jobsNew?teamId=workspace_123&archived.status=true&page=1&limit=1&id={job_id}",
                status_code=200,
                json={"jobs": [], "pagination_metadata": {"Pagination-Count": 0}}
            )
            ...
            # Mock checking if job exists in unarchived list (should return the job)
            m.get(
                f"https://cloudos.lifebit.ai/api/v2/jobsNew?teamId=workspace_123&archived.status=false&page=1&limit=1&id={job_id}",
                status_code=200,
...
def test_job_archive_mixed_valid_invalid_jobs():
    ...
    with requests_mock.Mocker() as m:
        ...
        m.get(
            "https://cloudos.lifebit.ai/api/v2/jobsNew?teamId=workspace_123&archived.status=true&page=1&limit=1&id=valid_job",
            status_code=200,
            json={"jobs": [], "pagination_metadata": {"Pagination-Count": 0}}
        )
        m.get(
            "https://cloudos.lifebit.ai/api/v2/jobsNew?teamId=workspace_123&archived.status=false&page=1&limit=1&id=valid_job",
            status_code=200,
        ...
        m.get(
            "https://cloudos.lifebit.ai/api/v2/jobsNew?teamId=workspace_123&archived.status=true&page=1&limit=1&id=invalid_job",
            status_code=200,
            json={"jobs": [], "pagination_metadata": {"Pagination-Count": 0}}
        )
        m.get(
            "https://cloudos.lifebit.ai/api/v2/jobsNew?teamId=workspace_123&archived.status=false&page=1&limit=1&id=invalid_job",
            status_code=200,
            json={"jobs": [], "pagination_metadata": {"Pagination-Count": 0}}
        )
