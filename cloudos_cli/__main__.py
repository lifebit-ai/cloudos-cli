...
def job_results(ctx,
    ...
    if status:
        ...
        try:
            ...
            # Helper function to convert status terminology and get color
            def get_status_display(status):
                ...
                display, color = status_config.get(status, (status, "white"))
                return display, color
            
            # Get the status of the results folder itself and convert it
            folder_status, status_color = get_status_display(deletion_status.get("status", "unknown"))
