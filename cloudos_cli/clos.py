...
class Cloudos:
    ...
    def get_project_members(self, project_id, verify=True):
        """Get all members from a Lifebit Platform project.

        Parameters
        ----------
        project_id : str
            The Lifebit Platform project ID from which to collect members.
        verify : [bool | str], optional
            Whether to use SSL verification or not. Alternatively, if
            a string is passed, it will be interpreted as the path to
            the SSL certificate file. Default is True.
        ...
        -------
        list | dict
            The parsed API response containing project members.
        """
        headers = {
            "Content-type": "application/json",
            "apikey": self.apikey
